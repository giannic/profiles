...
def add_categories(data):
    ...
    data['LinkedIn']['category'] = categories[0]
    data['Pinterest']['category'] = categories[0]
    data['Tumblr']['category'] = categories[0]
    data['Spotify']['category'] = categories[0]
    data['LastFM']['category'] = categories[0]
    ...
    data['Professional1']['category'] = categories[0]
    data['Professional2']['category'] = categories[0]
    data['Professional3']['category'] = categories[0]
    data['Professional4']['category'] = categories[0]
    data['Entertainment1']['category'] = categories[0]
    data['Entertainment2']['category'] = categories[0]
    data['Entertainment3']['category'] = categories[0]
    data['Entertainment4']['category'] = categories[0]
    data['Entertainment5']['category'] = categories[0]
